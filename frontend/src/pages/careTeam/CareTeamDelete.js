...
function CareTeamDelete() {
    ...
    function loaded() {
        return (
            <Container fluid>
                <h1 className='fs-1 fw-normal ms-sm-3 py-5 text-center'>Delete Care Team</h1>
                        ...
                        <Card.Body>
                            ...
                            <div className='d-flex justify-content-center'>
                                <Link className='me-3' to={`/careteam`}>
                                    <button type="button" onClick={deleteMyCareTeam} className='btn btn-danger text-white fs-5 fw-light px-3 py-1 border border-dark rounded-3'>Delete</button>
                                </Link>
