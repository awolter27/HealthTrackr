                    ...
                    <Card border="dark" className="text-center" id="card">
                        ...
                        <div className="d-flex justify-content-center">
                            <Link className="me-3" to={`/socialhistory`}>
                                <button type="button" onClick={deleteMySocialHistory} className="btn btn-danger border border-dark rounded-3 text-white fs-5 fw-light me-2 my-3 px-3 py-1">Delete</button>
                            </Link>
                            <Link className="ms-3" to={`/socialhistory`}>
                                <button type="button" className="btn btn-secondary border border-dark rounded-3 text-white fs-5 fw-light ms-2 my-3 px-3 py-1">Cancel</button>
                            </Link>
                        </div>
                    </Card>
                </div>
